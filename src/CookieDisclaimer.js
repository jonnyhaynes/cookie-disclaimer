...
export function init (options) {
  ...
  if(!readCookie(settings.name)) {
    ...
    getFileContents(settings.template, function (response) {
      ...
      else if (!hasClass(document.body, bodyClass)) document.body.className += ' ' + bodyClass;
      ...
      document.getElementById('close').onclick = function () {
        ...
        else document.body.className = document.body.className.replace(new RegExp('\\b'+ bodyClass+'\\b', 'g'), '');
